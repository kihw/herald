...
type TeamPredictionData struct {
	TeamSynergyScore     float64                 `json:"team_synergy_score"`
	PredictedTeamWinRate float64                 `json:"predicted_team_win_rate"`
	RoleOptimization     RoleOptimizationData    `json:"role_optimization"`
	CommunicationScore   float64                 `json:"communication_score"`
	TeamChemistry        TeamChemistryData       `json:"team_chemistry"`
	ImprovementAreas     []TeamImprovementArea   `json:"improvement_areas"`
}
